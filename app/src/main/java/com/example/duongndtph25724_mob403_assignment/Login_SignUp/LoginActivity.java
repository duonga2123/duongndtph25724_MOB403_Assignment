package com.example.duongndtph25724_mob403_assignment.Login_SignUp;
...
//authenticate user
                ...
                auth.signInWithEmailAndPassword(email, password).addOnCompleteListener(LoginActivity.this, new
